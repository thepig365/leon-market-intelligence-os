...
CREATE TABLE IF NOT EXISTS paper_trades (id INTEGER PRIMARY KEY AUTOINCREMENT, symbol TEXT, source TEXT, source_url TEXT, observed_at TEXT, schema_version TEXT, payload TEXT NOT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE IF NOT EXISTS paper_trade_events (id INTEGER PRIMARY KEY AUTOINCREMENT, symbol TEXT, source TEXT, source_url TEXT, observed_at TEXT, schema_version TEXT, payload TEXT NOT NULL, created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP);
